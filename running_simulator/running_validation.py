...
# Esegue n_reps repliche per un dato λ, calcolando R e N per ogni replica.
# Tra una replica e l'altra, gli stream RNG vengono salvati e ripristinati
# per garantire che TUTTE le repliche per lo stesso λ partano dallo stesso stato
# degli stream RNG (in modo da isolare la variabilità dovuta alla sola
# casualità interna della simulazione).
